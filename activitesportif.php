...
<div class="carroosel">
            <div class="container">
                <div class="card">
                    <h3 class="title">Musculation</h3>
                    <div class="bar">
                        <div class="emptybar"></div>
                        <div class="filledbar"></div>
                    </div>
                    <div class="circle">
                    <img src="image/muscu.jpg" width="80%" height="80%" />
                            <div class="clique2"> 
                                <a href="musculation.php">Plus d'information</a>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="circle">
                    <img src="image/fitness.jpg" width="74%" height="100%" />  
                            <div class="clique"> 
                                <a href="fitness.php">Plus d'information</a>
                            </div>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg">
                        </svg>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="circle">
                    <img src="image/biking.jpg" width="80%" height="100%" />
                    <div class="clique"> 
                                <a href="biking.php">Plus d'information</a>
                            </div>
                ...
                <div class="card">
                    <h3 class="title">Cardio-Training</h3>
                    <div class="bar">
                        <div class="emptybar"></div>
                        <div class="filledbar"></div>
                    </div>
                    <div class="circle">
                    <img src="image/cardiotraining.jpg" width="74%" height="100%" />
                            <div class="clique"> 
                                <a href="cardio-training.php">Plus d'information</a>
                            </div>
                ...
                <div class="card">
                    <h3 class="title">Cours Collectifs</h3>
                    <div class="bar">
                        <div class="emptybar"></div>
                        <div class="filledbar"></div>
                    </div>
                    <div class="circle">
                    <img src="image/courscollectifs.jpg" width="80%" height="120%" />
                            <div class="clique"> 
                                <a href="courscollectif.php">Plus d'information</a>
                            </div>
